    ...
    <footer className="relative bg-black text-white px-8 md:px-12 py-8 md:py-12 font-sans animate-fadeIn">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 transition-all duration-300">
            ...
            <ul className="flex flex-wrap justify-center gap-6 md:gap-8">
              {[
                ...
                <li key={index}>
                  <a
                    href="#"
                    className="text-base text-[#a3a3a3] hover:text-[#fff] transition-all duration-300 hover:-translate-y-0.5 inline-block"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="text-base leading-relaxed">
          <a
            href="mailto:contact@mahtabtech.com"
            className="text-[#a3a3a3] hover:text-[#fff]"
          >
      ...
      <div className="border-t border-gray-800 pt-8 mt-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <ul className="flex flex-wrap justify-center gap-6">
            {["Privacy Policy", "Terms of Use", "Trust & Safety"].map(
              (item, index) => (
                <li
                  key={index}
                  className="text-sm text-[#a3a3a3] hover:text-[#fff] transition-duration-300"
                >
                  <a href="#">{item}</a>
                </li>
              )
          ...
          <p className="text-sm order-3 md:order-2 md:mr-32">
            ...
            {[
              ...
              <li key={index}>
                <a
                  ...
                  className="text-xl text-[#a3a3a3] hover:text-[#fff] transition-duration-300"
                >
